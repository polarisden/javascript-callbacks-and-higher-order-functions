...
1. ใน Exercise นี้ ฟังก์ชันใดเป็น Callback Function?
    function checkGradeOver70 สังเกตจากเป็น function ที่ถูกใช้ใน function อื่นอีกที โดยแทนใน operation (parameter ของ function atLeastFive)

2. ใน Exercise นี้ ฟังก์ชันใดเป็น Higher Order Function?
    function atLeastFive สังเกตจากเป็น function ที่ใช้ parameter เป็น function checkGradeOver70
